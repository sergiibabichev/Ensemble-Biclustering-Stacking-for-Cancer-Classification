"""
Classification module for PMD biclustering-derived gene subset.
...
Outputs
-------
All outputs are saved in: results_PMD

- best_rf_params_PMD.json
- best_xgb_params_PMD.json
- classification_report_RF_PMD.csv
- classification_report_XGB_PMD.csv
- classification_report_RF_PMD.png
- classification_report_XGB_PMD.png
- cv_scores_RF_PMD.csv
- cv_scores_XGB_PMD.csv
- metrics_summary_PMD.csv
- metrics_summary_PMD.json
- confusion_matrix_RF_PMD.csv
- confusion_matrix_XGB_PMD.csv
...
# 0) Configuration
# ---------------------------------------------------------------------
DATA_CSV = "PMD_subset_unique_genes.csv"
TAG = "PMD"
OUT_DIR = Path("results_PMD")
