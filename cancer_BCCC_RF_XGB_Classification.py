"""
Classification module for BCCC biclustering-derived gene subset.
...
Outputs
-------
All outputs are saved in: results_BCCC

- best_rf_params_BCCC.json
- best_xgb_params_BCCC.json
- classification_report_RF_BCCC.csv
- classification_report_XGB_BCCC.csv
- classification_report_RF_BCCC.png
- classification_report_XGB_BCCC.png
- cv_scores_RF_BCCC.csv
- cv_scores_XGB_BCCC.csv
- metrics_summary_BCCC.csv
- metrics_summary_BCCC.json
- confusion_matrix_RF_BCCC.csv
- confusion_matrix_XGB_BCCC.csv
...
# 0) Configuration
# ---------------------------------------------------------------------
DATA_CSV = "BCCC_subset_unique_genes.csv"
TAG = "BCCC"
OUT_DIR = Path("results_BCCC")
