"""
Classification module for STACK_reduced biclustering-derived gene subset.
...
Outputs
-------
All outputs are saved in: results_STACK_reduced

- best_rf_params_STACK_reduced.json
- best_xgb_params_STACK_reduced.json
- classification_report_RF_STACK_reduced.csv
- classification_report_XGB_STACK_reduced.csv
- classification_report_RF_STACK_reduced.png
- classification_report_XGB_STACK_reduced.png
- cv_scores_RF_STACK_reduced.csv
- cv_scores_XGB_STACK_reduced.csv
- metrics_summary_STACK_reduced.csv
- metrics_summary_STACK_reduced.json
- confusion_matrix_RF_STACK_reduced.csv
- confusion_matrix_XGB_STACK_reduced.csv
...
# 0) Configuration
# ---------------------------------------------------------------------
DATA_CSV = "STACK_short_subset_unique_genes.csv"
TAG = "STACK_reduced"
OUT_DIR = Path("results_STACK_reduced")
