"""
Classification module for ISA biclustering-derived gene subset.
...
Outputs
-------
All outputs are saved in: results_ISA

- best_rf_params_ISA.json
- best_xgb_params_ISA.json
- classification_report_RF_ISA.csv
- classification_report_XGB_ISA.csv
- classification_report_RF_ISA.png
- classification_report_XGB_ISA.png
- cv_scores_RF_ISA.csv
- cv_scores_XGB_ISA.csv
- metrics_summary_ISA.csv
- metrics_summary_ISA.json
- confusion_matrix_RF_ISA.csv
- confusion_matrix_XGB_ISA.csv
...
# 0) Configuration
# ---------------------------------------------------------------------
DATA_CSV = "ISA_subset_unique_genes.csv"
TAG = "ISA"
OUT_DIR = Path("results_ISA")
